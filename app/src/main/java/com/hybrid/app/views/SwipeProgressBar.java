...
/**
 * Custom progress bar that shows a cycle of colors as widening circles that overdraw each other. When finished, the bar
 * is cleared from the inside out as the main cycle continues. Before running, this can also indicate how close the user
 * is to triggering something (e.g. how far they need to pull down to trigger a refresh).
 */
final class SwipeProgressBar {
	...
	/**
	 * Update the progress the user has made toward triggering the swipe gesture. and use this value to update the
	 * percentage of the trigger that is shown.
	 */
